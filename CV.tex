\documentclass[singlecolumn,singlespace,11pt,a4paper]{article}
...
\noindent \textbf{Email:} \texttt{Shoaib.Akram@anu.edu.au} \\ 
\noindent \textbf{Linkedin:} shoaib-akram-58999211b \\
\noindent \textbf{Citizenship:} Australian
...
\noindent \textbf{January 2026 - April 2026}\\
Senior Lecturer (Tenured) at The Australian National University \\
\end{minipage}
\\
\\
\\
\begin{minipage}{\linewidth}
\noindent \textbf{January 2020 - December 2025}\\
...
\item 
I. Kolokasis, \textbf{S. Akram}, F. Zakkak, P. Pratikakis, A. Bilas, ``FlexHeap: Dynamic I/O-Aware Heap Resizing for Managed Applications,''ACM SIGPLAN Conference on Programming Language Design and Implementation (PLDI), 2026. {\color{blue} Acceptance Rate: 107/402}
...
University of Crete, Department of Computer Science, 2020 onward\\
\indent Iacovos G. Kolokasis (Unofficial Co-advisor and Member of the Ph.D. committee) \\
...
\\
\\
Australian National University, School of Computing, 2024 onward\\
\indent Jackson Kilrain-Mottram (Primary Advisor) \\
\indent Thesis Topic: Scheduling in Distributed Storage Systems
\\
\\
Australian National University, School of Computing, 2026 onward\\
\indent Adnan Hasnat (Primary ANU Advisor) \\
\indent Joint/Dual Ph.D. agreement between ANU and Ruhr University Bochum (RUB) \\
\indent RUB Advisor: Yuval Yarom \\
\indent Thesis Topic: Hardware Security 
...
\\
{\color{BrickRed} \textbf{$\longrightarrow$ \emph{University Medal for Academic Excellence}}}
...
{\color{BrickRed} \textbf{$\longrightarrow$ \emph{University Medal for Academic Excellence}}}
\\
{\color{BrickRed} \textbf{$\longrightarrow$ \emph{Erin Brent Computer Science Prize for best honours result}}}
...
\item Libby Boas (2025, ANU, PhB Advanced Studies Course, 6 units)
...
\item Assistant (Associate) Director, International (ANU School of Computing, 2025)
\end{itemize}


\subsection*{Leadership Roles in Conference Organization}
\begin{itemize}
\item Poster \textit{Co-Chair}, International Conference on Architectural Support for Programming Languages and Operating Systems (ASPLOS), 2027
\item Sponsorship \textit{Chair}, ACM SIGPLAN Symposium on Principles and Practice of Parallel Programming (PPoPP), 2026
\item Program \textit{Co-Chair}, Virtual Machines and Language Implementations (VMIL), 2025 (workshop collocated with SPLASH)
\end{itemize}


\subsection*{Program Committees and Peer Reviewing}
\begin{itemize}
\item Regular Program Committee, IEEE/ACM International Symposium on Microarchitecture (MICRO), 2026
...
\item Invited Reviewer (2025), Future Generation Computer Systems (FGCS)
...
\begin{itemize}
\item Google (Unrestricted gift, 2025), 77,000 AUD
\item ASD-ANU Co-Lab Honours grant for undergraduate student, 8,000 AUD (Kshama Patel, 2025) 
\item ASD-ANU Co-Lab Honours grant for undergraduate student, 8,000 AUD (Anson Thai, 2024)
\item SIGPLAN SIGPLAN Professional Activities Committee (PAC) student travel grant, 2,500 AUD (Aditya Chilukuri, 2023)
\item ANU start-up grant (2020), 200,000 AUD
\end{itemize}
